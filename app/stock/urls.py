...
urlpatterns = [
    ...
    path("movimientos-medicamento", MovimientoMedicamentoAPIView.as_view(), name="movimiento-medicamento-l"),
    path("movimientos-medicamento/<int:medicamento>", MovimientoMedicamentoAPIView.as_view(), name="movimiento-medicamento-d"),
